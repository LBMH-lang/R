setwd("C:/Users/lebmd/OneDrive/Desktop/HUY")
...
pie(Cases, main = "tổng số người chết mỗi năm")
...
pie3D(Cases, main = "số người chết cho mỗi quốc gia",
      explode=0.1,
      labels = names(Cases),
      labelcex=0.6,
)
...
pie3D(Cases, main = "tổng số người chết mỗi quốc gia",
      explode=0.1,
      labels = names(Cases),
      labelcex=0.6,
)
